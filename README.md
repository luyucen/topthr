...
1. Continuation based on decreasing Emin. For example, run `demo_example_200X100` in MATLAB, to apply this continuation method on Example 1 with mesh resolution 200X100;
